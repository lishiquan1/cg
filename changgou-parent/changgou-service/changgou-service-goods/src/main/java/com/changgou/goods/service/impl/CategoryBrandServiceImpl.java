...
public class CategoryBrandServiceImpl implements CategoryBrandService {
     ...
     */
    @Override
    public PageInfo<CategoryBrand> findPage(Integer page, Integer size){
        //静态分页
     ...
     */
    @Override
    public PageInfo<CategoryBrand> findPage(CategoryBrand categoryBrand, Integer page, Integer size){
        // 分页
        PageHelper.startPage(page,size);
        // 搜索条件构建
        Example example = createExample(categoryBrand);
